...
for i=1:length(subj);
    ...
    %
    %    Workbook: /Users/asternin/Documents/PhDProject.git/Music and Memory - Lucy/EdatFiles/P101/ISC_EXP_BOLD-Part2-101-1-excel.xlsx
    %
    ...
    %% Import the data
    [~, ~, raw] = xlsread(['/Users/asternin/Documents/PhDProject.git/Music and Memory - Lucy/EdatFiles/P' num2str(subj) '/BOLD-Part2-' num2str(subj) '-' num2str(ses) '.xlsx']);
    ...
    save(['P' num2str(subj) '/Bold2-' num2str(ses) '.mat'],'names','onsets','durations');
end