function edat_2_mat_Bold1(subj,ses)
for i=1:length(subj);
    subj=subj(i);
    %% Import data from spreadsheet
    % Script for importing data from the following spreadsheet:
    %
    %    Workbook: /Users/asternin/Documents/PhDProject.git/Music and Memory - Lucy/EdatFiles/P101/ISC_EXP_BOLD-Part1-101-1-excel.xlsx
    %
    ...
    %% Import the data
    [~, ~, raw] = xlsread(['/Users/asternin/Documents/PhDProject.git/Music and Memory - Lucy/EdatFiles/P' num2str(subj) '/BOLD-Part1-' num2str(subj) '-' num2str(ses) '.xlsx']);
    ...
    Data.Duration=(minus(Data.Slide1FinishTime,Data.Slide1OnsetTime))/1000;
    Data.Onset=(minus(Data.Slide1OnsetTime,Data.BegTime))/1000;
    ...
    save(['P' num2str(subj) '/Bold1-' num2str(ses) '.mat'],'names','onsets','durations');
end