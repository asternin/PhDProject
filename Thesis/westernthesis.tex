...
\newcommand{\super}{Dr. Adrian M. Owen} %supervisor
\newcommand{\superj}{} %joint supervisor, if there is one, leave blank if not (lbin)... only one of the three.
\newcommand{\superc}{Dr. Jessica A. Grahn} %co-supervisor, if there is one, leave blank if not (lbin)
\newcommand{\supera}{} %alternate supervisor, if there is one, leave blank if not (lbin)
\newcommand{\sco}{Dr. J. Paul Minda}  %member of supervisory committee
\newcommand{\sct}{Dr. Stefan Kohler}  %other member of supervisory committee (lbin)
\newcommand{\examo}{Dr. }  %examining committee (up to four, if less leave blank)
\newcommand{\examt}{Dr. }
\newcommand{\examth}{Dr. }
\newcommand{\examf}{}
\newcommand{\department}{Psychology}
...
\newcommand{\titl}{THESIS TITLE GOES HERE}
...
\begin{tabular}{l}
\underline{Co-Supervisor:}\vspace{0.35in}
\isdefinedsig{\super}
\isco{\superc}
\isjoint{\superj}
\isalt{\supera}
